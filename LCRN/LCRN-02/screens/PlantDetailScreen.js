    ...
    function renderRequirements() {
        return (
            <View
                ...
                <RequirementDetail icon={icons.sun} label="Sunlight" detail="15&#8451;" />
                <RequirementDetail icon={icons.drop} label="Water" detail="250 ML Daily" />
                <RequirementDetail icon={icons.temperature} label="Room Temp" detail="25&#8451;" />
                <RequirementDetail icon={icons.garden} label="Soil" detail="3Kg" />
                <RequirementDetail icon={icons.seed} label="Fertilizer" detail="150Mg" />
            </View>
        );
    }
